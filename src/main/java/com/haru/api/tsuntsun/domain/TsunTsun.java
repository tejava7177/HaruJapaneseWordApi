...
public class TsunTsun {
    ...
    private TsunTsun(User sender, User receiver, Word word, DailyWordItem dailyWordItem, LocalDate targetDate) {
        this.sender = sender;
    ...
    public static TsunTsun sent(User sender, User receiver, Word word, DailyWordItem dailyWordItem, LocalDate targetDate) {
        return new TsunTsun(sender, receiver, word, dailyWordItem, targetDate);
    }
